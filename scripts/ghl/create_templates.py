"""
SmithFit GHL Email Template Creator
────────────────────────────────────
Creates all 31 email templates in GHL via API.
Run once — skips any templates that already exist by name.
To force-update existing templates, the script will UPDATE them.

Usage:
  python3 scripts/ghl/create_templates.py
"""
...
# ── All 31 Templates ──────────────────────────────────────────────────────────
# v4 — Full professional rewrite. Avatar-first copy, nurse-specific scenarios,
...
TEMPLATES = [
...

    {
        ...
        "subject": "Your gameplan call is done — here's your 4-week execution map",
        "html": wrap_html(
            h("The call is done. Now the real work starts — and it's simpler than you think.") +
            p("Hey {{contact.first_name}},") +
            p("Your gameplan call is complete. Which means you now have something that most people trying to change their health never get: a specific plan built around your actual life. Your shifts. Your sleep patterns. Your history with food. Your body's specific signals.") +
            p("Not a template. Yours.") +
            p("Here's how the next 4 weeks execute:") +
            p(bold("Week 1 — Foundation") + "<br>"
              "One habit at a time. The Metabolic Cocktail daily — this is your anchor, non-negotiable. Pull up your Work Day meal plan and use it on your next work day, even imperfectly. Complete your first FitMetrics AI check-in — it needs data to start personalizing, so answer it honestly.") +
            p(bold("Week 2 — Layer the Tools") + "<br>"
              "Start using MealLens. Scan 1–2 meals per day — your next hospital cafeteria run, your post-shift meal, whatever you're actually eating. You're looking for patterns, not perfection. If you have bloodwork, upload it to BioSync this week. Even a basic panel gives us useful baseline data. And show up to the weekly group coaching call — this is where your specific questions get live answers.") +
            p(bold("Week 3 — Chaos-Proof It") + "<br>"
              "Use the Chaos-Day Rescue Plan on a non-chaotic day first — so when the brutal shift hits, the moves are already familiar. Check your FitMetrics AI feedback from Week 2. By now it's starting to see your specific patterns. Make one adjustment based on what it shows you.") +
            p(bold("Week 4 — Assess and Accelerate") + "<br>"
              "Review 3 weeks of FitMetrics data. What moved? What stayed flat? What surprised you? Engage deeply in the VIP community this month — your Month 1 VIP access is your most valuable window. At Day 28, I'll personally review your data and send you a coach note.") +
            p("You are set up better than 95% of people who attempt to change their health while working shift work. The tools are built for your life. The plan is specific to your body.") +
            p("Use all of it.") +
            sig()
        ),
    },
...

    {
        ...
        "html": wrap_html(
            ...
            p("But here's what I actually want more than you spending $10:") +
    ...
    {
        "name": "FOMO-C4: Keep Everything for $2.25/Day",
        "subject": "4 days left — $2.25/day to keep everything that's already working",
        "html": wrap_html(
...
def main():
    print("\n" + "═" * 60)
    print("  SMITHFIT — CREATE/UPDATE GHL EMAIL TEMPLATES")
    print("═" * 60 + "\n")
    ...
    if failed > 0:
        print("  ⚠️  Some templates failed. Check the response above.")
